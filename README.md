# Magento 2 Ha Hello Magento 2

[Magento 2 Ha Hello Magento](https://landofcoder.com/) extension by LandOfCoder display hello magento 2 text and more

- Disable hello magento 2 text
...
```
composer require landofcoder/module-ha-hello-magento
...
The module is simple to display hello magento text. It is better to training for magento 2 backend developer.
